...
{
    public class PersianRadHelper : RadGridLocalizationProvider
    {
        public override string GetLocalizedString(string id)
        {
            switch (id)
            {
                ...
                case RadGridStringId.FilterFunctionEndsWith:
                    return "پایان یابد با"; //Ends with
                ...
                case RadGridStringId.AddNewRowString:
                    return "برای افزودن سطر جدید اینجا کلیک کنید";
                ...
                case RadGridStringId.ConditionalFormattingMenuItem:
                    return "قالب بندی شروطی"; //Conditional Formatting
                case RadGridStringId.GroupByThisColumnMenuItem:
                    return "گروه بندی بر حسب این ستون"; //Group by this column
                case RadGridStringId.UngroupThisColumn:
                    return "حذف این ستون از گروه بندی "; //Ungroup this column
                case RadGridStringId.ColumnChooserMenuItem:
                    return "انتخاب کننده ستون"; //Column Chooser
                ...
                case RadGridStringId.ConditionalFormattingCaption:
                    return "قالب بندی شروطی"; //Custom Formatting Condition Editor
                ...
                case RadGridStringId.ColumnChooserFormMessage:
                    return "برای حذف یکی از ستونها، آن ستون را به اینجا بکشید";
                ...
                case RadGridStringId.GroupingPanelDefaultMessage:
                    return "برای گروهبندی ستونها، ستون موردنظر را به اینجا بکشید";
                case RadGridStringId.GroupingPanelHeader:
                    return ":گروه بندی بر حسب";
